...
(function() {
  ...
  showLocations = {
    "Definiti Space Theater": ["One World, One Sky; Big Bird's Adventure", "Earth, Moon & Sun", "Night Sky Live!", "Undiscovered Worlds", "Vuelta definitiva a la Luna", "Back to the Moon for Good", "Un Mundo, Un Cielo", "Estrellas que Explotan", "Exploding Stars"],
    "Granger Sky Theater": ["Welcome To The Universe", "Cosmic Wonder", "Maravilla C&#243smica"],
  ...
  Calendar = (function() {
    ...
    Calendar.prototype.gotShowTimes = function() {
      ...
      this.showTimes["Maravilla C&#243smica"] = this.showTimes["Maravilla Cósmica"] || [];
      _ref = this.showTimes;
      _results = [];
      for (show in _ref) {
        times = _ref[show];
