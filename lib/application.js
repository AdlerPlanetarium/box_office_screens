...
(function() {
  ...
  $(document).ready(function() {
    var cal, time_shift, update_screen, update_show_times,
      _this = this;
    cal = new Calendar();
    window.cal = cal;
    ...
    update_screen = function() {
      var show, show_name, shows, showsList, theater, theaterDiv, theater_id, theater_name, times, _results;
        ...
        if (theater) {
          ...
          times = ((function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              show = _ref[_i];
              _results1.push("<span class=' time " + (show.time.isAfter(moment().subtract("hours", time_shift)) && show.available ? "active" : "") + "' > " + (show.time.format('h:mm a')) + "</span>");
            }
            return _results1;
          })()).join(", ");
          if (times) {
            _results.push(theaterDiv.append("<div class='show_container'> <p class='show'>" + show_name + "</p><p class='times'> " + times + " </p> </div>"));
          } else {
  ...
  Calendar = (function() {
    ...
    Calendar.prototype.gotShowTimes = function() {
      ...
      this.showTimes["Maravilla Cósmica"] = [];
